...
import craftBoardOutreachRouter from "./routes/craftBoardOutreach.js";
import craftBoardStorefrontRouter from "./routes/craftBoardStorefront.js";
import craftBoardStorefrontSeoRouter from "./routes/craftBoardStorefrontSeo.js";
...
export function createApp() {
  ...
  app.use("/", craftBoardOutreachRouter);
  app.use("/", craftBoardStorefrontRouter);
  app.use("/", craftBoardStorefrontSeoRouter);
