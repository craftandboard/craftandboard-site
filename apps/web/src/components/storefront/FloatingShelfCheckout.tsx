      ...
      <div className="space-y-6">
        <section className="rounded-[2rem] border border-[#dbcab9] bg-[#fffaf4] p-8">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-[#5c4a3d]">
            Craft & Board can price this shelf directionally, but the current configuration needs install or span review before a standard purchase submission moves into FieldMetriq.
          </p>
